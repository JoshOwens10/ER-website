...
<link a href="ER.css" rel = "stylesheet">
</head>
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav">
                ...
                <a href="CarrerAdvice.php" class="nav-item nav-link active">carrer Advice</a>
                <a href="CompanyProfiles.php" class="nav-item nav-link">Company Profiles</a>
